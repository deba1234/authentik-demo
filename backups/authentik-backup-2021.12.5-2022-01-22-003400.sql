...
598	411f86cf-e410-4443-876b-9f3c6aefbd96	15	63	3
599	2	35	145	3
\.
...
SELECT pg_catalog.setval('public.authentik_core_user_user_permissions_id_seq', 444, true);
...
SELECT pg_catalog.setval('public.guardian_userobjectpermission_id_seq', 599, true);
